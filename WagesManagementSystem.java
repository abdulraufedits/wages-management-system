...
public class WagesManagementSystem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 159, -1, -1));
        ...
        jPanel3.add(btn_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 385, 140, 36));
        jPanel3.add(txt_name_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 255, 140, 42));

        jLabel5.setText("username");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 233, -1, -1));

        jLabel6.setText("password");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 309, -1, -1));
        ...
        jPanel3.add(txt_pass_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, 140, 40));
        ...
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 159, -1, -1));
        ...
        jPanel4.add(btn_reg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 385, 140, 36));
        jPanel4.add(txt_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 255, 140, 42));

        jLabel9.setText("username");
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 233, -1, -1));

        jLabel10.setText("password");
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 309, -1, -1));
        jPanel4.add(txt_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 330, 140, 40));
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if(user.equals("employee")){
            c.runSelect("SELECT empname, pass from employee WHERE empname='" + name + "' AND pass='"+pass+"'");
            JOptionPane.showMessageDialog(null, "Logged in as " + user +": " + name);
        } else if(user.equals("manager")){
            c.runSelect("SELECT managername, pass from manager WHERE managername='" + name + "' AND pass='"+pass+"'");
            JOptionPane.showMessageDialog(null, "Logged in as " + user +": " + name);
        }
